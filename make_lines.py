# This script asks you to choose an author, a scoring threshold, and a min text length (in words)
# It them gathers all texts that follow, chronologically, and which are the appropriate size
# and then it graphs their outcomes and counts.
